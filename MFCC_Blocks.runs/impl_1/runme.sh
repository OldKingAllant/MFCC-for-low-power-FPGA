...
HD_PWD='D:/Programming/TESI/MFCC_Blocks/MFCC_Blocks.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log preemphasis.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source preemphasis.tcl -notrace
